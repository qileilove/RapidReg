...
public class CaseService extends RecordService {
    ...
    private static final CaseService RECORD_SERVICE = new CaseService();
    ...
    public List<Case> getCasesSearchResult(String uniqueId, String name, int ageFrom, int ageTo,
                                           String caregiver, Date date) {
        ConditionGroup searchCondition = getSearchCondition(uniqueId, name, ageFrom, ageTo, caregiver, date);
        return caseDao.getAllCasesByConditionGroup(searchCondition);
    }
