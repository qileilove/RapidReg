...
public class TracingRequestSearchFragment extends MvpFragment<TracingRequestListView, TracingRequestListPresenter>
        implements TracingRequestListView {
    public static final String TAG = TracingRequestSearchFragment.class.getSimpleName();
    ...
    private List<Tracing> getSearchResult(Map<String, String> filters) {
