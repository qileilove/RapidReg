...
public class TracingRequestRegisterAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public TracingRequestRegisterAdapter(Context context, List<Field> fields, boolean isMiniForm) {
        this.fields = fields;
        this.activity = (TracingRequestActivity) context;
    ...
    public int getItemViewType(int position) {
        ...
        if (field.isPhotoUploadBox()) {
            if (activity.getCurrentFeature() != TracingRequestFeature.DETAILS) {
